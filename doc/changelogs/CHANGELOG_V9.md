...
* [[`d3c2534bbe`](https://github.com/nodejs/node/commit/d3c2534bbe)] - **(SEMVER-MAJOR)** **assert**: use destructuring for errors (Ruben Bridgewater) [#18247](https://github.com/nodejs/node/pull/18247)
